...
public class SistemaBiblioteca {
    public static void main(String[] args) {
        ...
        try {
            gerenciador.salvarDadosEmArquivo("biblioteca.txt", biblioteca.getLivros(), biblioteca.getMembros(), biblioteca.getEmprestimos());
            gerenciador.carregarDadosDeArquivo("biblioteca.txt");
        } catch (IOException e) {
            e.printStackTrace();
        }
